...
To find the transportation costs:
```{r}
...
print(shippingAham$`sum(minShipping)`+shippingBnoHam$sum)

# print transportation costs of scenario B, where Supplier B gets the hammers and Supplier A does not
print(shippingBham$`sum(minShipping)`+shippingAnoHam$sum)
```
